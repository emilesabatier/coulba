...
import { integer, numeric, pgEnum, pgTable, text, unique } from "drizzle-orm/pg-core"
...
export const sheets = pgTable(
    "sheets",
    {
        ...
        gross: numeric("gross", { scale: 2 }).notNull(),
        allowance: numeric("allowance", { scale: 2 }).notNull(),
