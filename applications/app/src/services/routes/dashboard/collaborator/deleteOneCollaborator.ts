...
type DeleteOneCollaborator = {
    params: DashboardCollaborator.DeleteOneCollaboratorParams
}

export async function deleteOneCollaborator(props: DeleteOneCollaborator): Promise<ReturnResponse<DashboardCollaborator.DeleteOneCollaboratorReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.collaborator.deleteOneCollaboratorReturn.safeParse(await response.json())
