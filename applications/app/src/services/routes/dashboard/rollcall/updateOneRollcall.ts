...
type UpdateOneRollcall = {
    params: DashboardRollcall.UpdateOneRollcallParams,
    body: DashboardRollcall.UpdateOneRollcallBody
}

export async function updateOneRollcall(props: UpdateOneRollcall): Promise<ReturnResponse<DashboardRollcall.UpdateOneRollcallReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.rollcall.updateOneRollcallReturn.safeParse(await response.json())
