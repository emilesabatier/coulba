...
type UpdateOneRegistrationForm = {
    params: DashboardRegistrationForm.UpdateOneRegistrationFormParams,
    body: DashboardRegistrationForm.UpdateOneRegistrationFormBody
}

export async function updateOneRegistrationForm(props: UpdateOneRegistrationForm): Promise<ReturnResponse<DashboardRegistrationForm.UpdateOneRegistrationFormReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.registrationForm.updateOneRegistrationFormReturn.safeParse(await response.json())
