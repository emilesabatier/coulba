...
type UpdateOneConversation = {
    params: DashboardConversation.UpdateOneConversationParams,
    body: DashboardConversation.UpdateOneConversationBody
}

export async function updateOneConversation(props: UpdateOneConversation): Promise<ReturnResponse<DashboardConversation.UpdateOneConversationReturn>> {
    try {
