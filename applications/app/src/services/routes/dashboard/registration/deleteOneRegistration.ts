...
type DeleteOneRegistration = {
    params: DashboardRegistration.DeleteOneRegistrationParams
}

export async function deleteOneRegistration(props: DeleteOneRegistration): Promise<ReturnResponse<DashboardRegistration.DeleteOneRegistrationReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.registration.deleteOneRegistrationReturn.safeParse(await response.json())
