...
type DeleteOneContact = {
    params: DashboardContact.DeleteOneContactParams
}

export async function deleteOneContact(props: DeleteOneContact): Promise<ReturnResponse<DashboardContact.DeleteOneContactReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.contact.deleteOneContactReturn.safeParse(await response.json())
