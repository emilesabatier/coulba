...
type DeleteOneLesson = {
    params: DashboardLesson.DeleteOneLessonParams
}

export async function deleteOneLesson(props: DeleteOneLesson): Promise<ReturnResponse<DashboardLesson.DeleteOneLessonReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.lesson.deleteOneLessonReturn.safeParse(await response.json())
