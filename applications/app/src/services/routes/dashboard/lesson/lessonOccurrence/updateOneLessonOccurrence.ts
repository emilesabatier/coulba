...
type UpdateOneOccurrence = {
    params: DashboardOccurrence.UpdateOneOccurrenceParams,
    body: DashboardOccurrence.UpdateOneOccurrenceBody
}

export async function updateOneOccurrence(props: UpdateOneOccurrence): Promise<ReturnResponse<DashboardOccurrence.UpdateOneOccurrenceReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.occurrence.updateOneOccurrenceReturn.safeParse(await response.json())
