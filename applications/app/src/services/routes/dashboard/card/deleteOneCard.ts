...
type DeleteOneCard = {
    params: DashboardCard.DeleteOneCardParams
}

export async function deleteOneCard(props: DeleteOneCard): Promise<ReturnResponse<DashboardCard.DeleteOneCardReturn>> {
    try {
        ...
        const parsedResponse = dashboardSchema.card.deleteOneCardReturn.safeParse(await response.json())
